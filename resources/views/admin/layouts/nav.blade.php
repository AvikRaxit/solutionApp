      ...
      <ul class="nav navbar-nav flex-row">
        ...
        <li class="nav-item d-md-none">
          <a class="navbar-brand" href="index.html">
            <img class="brand-logo d-none d-md-block" alt="CryptoDash admin logo" src="{{ asset('bcnd/images/logo/logo.png') }}">
            <img class="brand-logo d-sm-block d-md-none" alt="CryptoDash admin logo sm" src="{{ asset('bcnd/images/logo/logo-sm.png') }}">
          </a>
        </li>
        <li class="nav-item d-md-none">
