    ...
    <div class="content-body">
      ...
      <div class="row match-height">
        <div class="col-xl-4 col-lg-12">
          ...
          <div class="card">
            <div class="card-content">
              <img class="img-fluid" src="{{ asset('bcnd/images/pages/blog-post.png') }}" alt="Card image cap">
              <div class="card-body">
            ...
            <div class="card-footer border-top-blue-grey border-top-lighten-5 text-muted">
              ...
              <span class="float-right">
                <a href="#" class="card-link">Read More <i class="fa fa-angle-right"></i>
                </a>
              </span>
            </div>
          </div>
                    ...
                    <div class="timeline">
                      <div class="events-wrapper">
                        <div class="events">
                          <ol>
                            <li>
                              <a href="#0" data-date="16/01/2018" class="selected">16 Jan</a>
                            </li>
                            <li>
                              <a href="#0" data-date="28/02/2018">28 Feb</a>
                            </li>
                            <li>
                              <a href="#0" data-date="20/04/2018">20 Mar</a>
                            </li>
                            <li>
                              <a href="#0" data-date="20/05/2018">20 May</a>
                            </li>
                            <li>
                              <a href="#0" data-date="09/07/2018">09 Jul</a>
                            </li>
                            <li>
                              <a href="#0" data-date="30/08/2018">30 Aug</a>
                            </li>
                            <li>
                              <a href="#0" data-date="15/09/2018">15 Sep</a>
                            </li>
                          </ol>
                    ...
                    <div class="events-content">
                      <ol>
                        <li class="selected" data-date="16/01/2018">
                          ...
                          <p class="lead mt-2"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illum praesentium officia, fugit recusandae ipsa, quia velit nulla adipisci? Consequuntur aspernatur at. </p>
                        </li>
